...
{  public $verifyCode;
	...
	public function rules()
	{
		...
		return array(
			...
			array('iduser, name, lastname, docid, username, password, email', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$condition = $user->iduser;
        $criteria->addSearchCondition('iduser',$condition);
 ...
 if ($file = CUploadedFile::getInstance($this, 'photo')) {
        ...
        $this->photo = base64_encode($tmpfile_contents);
    }
