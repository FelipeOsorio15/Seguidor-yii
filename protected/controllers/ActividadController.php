...
class ActividadController extends Controller
{
	...
	{
        //Actividad::model()->setIdproyecto($id);
	...
	{
		/// $this->idproyecto=$id; //Manager automatico
		//Aqui se le puso $id al action index debido a que en el view del proyecto se hizo un subrayado en id y se paso array('view', 'id'=>$data->idactividad))
       
		$dataProvider = new CActiveDataProvider(Actividad::model(), array(
    'criteria'=>new CDbCriteria(array(
            'condition' => 'idproyecto=?',
            'params' => array($id),
    )),
));
